$(document).ready(function(){
    ...
    paramContent + $('.-url').each(function(){
        ...
        $([
            ...
            $(this).text('https://owsuhn.github.io/dashboard/');
            _this.find($(param + '__link.-original')).attr('href', 'https://owsuhn.github.io/dashboard/')
        });
        // event: click
        _thisRandomButton.click(function(){
            ...
            _thisLink + $('.-random').text('https://owsuhn.github.io/dashboard/' + _thisRandomParam).attr('href', 'https://owsuhn.github.io/dashboard/' + _thisRandomParam).addClass('-active');
        });
    });
