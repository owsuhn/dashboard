$(document).ready(function(){
    ...
    paramContent + $('.-url').each(function(){
        ...
        $([
            ...
            _this.find($(param + '__link.-original')).attr('href', document.URL.substring(document.URL.lastIndexOf('.html'), 0) + '--access.html')
        });
        // event: click
        _thisRandomButton.click(function(){
            ...
            _thisLink + $('.-random').text(document.URL + _thisRandomParam).attr('href', document.URL.substring(document.URL.lastIndexOf('.html'), 0) + '--access.html' + _thisRandomParam).addClass('-active');
        });
    });
    // each
